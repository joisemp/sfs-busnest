...
This module defines the URL patterns for driver-related views including refueling record 
management and student lists. All driver operations are scoped to their single assigned 
bus in the active registration.
"""
