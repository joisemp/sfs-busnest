...
def generate_ids_pdf(students):
    ...
    for index, student in enumerate(students):
        # Clean pickup and drop points, provide default value if None
        pickup_point_cleaned = (student['pickup_point__name'] or "-").split('(')[0].strip()
        drop_point_cleaned = (student['drop_point__name'] or "-").split('(')[0].strip()
        ...
        if y_offset < margin_y:
            ...
            footer_text = "Generated by IDentiGenix"
        ...
        c.drawString(x_offset + 20, y_offset + 98 - 10, student['student_name'].upper())
        ...
        if pickup_label:
            c.drawString(x_offset + 20, y_offset + 80 - 10, f"PICKUP : {pickup_label} ({pickup_point_cleaned})")
        else:
            c.drawString(x_offset + 20, y_offset + 80 - 10, f"PICKUP : -")
        
        if drop_label:
            c.drawString(x_offset + 20, y_offset + 65 - 10, f"DROP : {drop_label} ({drop_point_cleaned})")
        else:
